...
void Options_MenuInit( void ) {
	...
	s_options.banner.string		    = (char *)"SYSTEM SETUP";
	...
	s_options.graphics.string			= (char *)"GRAPHICS";
	...
	s_options.display.string			= (char *)"DISPLAY";
	...
	s_options.sound.string				= (char *)"SOUND";
	...
	s_options.network.string			= (char *)"NETWORK";
