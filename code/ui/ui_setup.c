...
static void UI_SetupMenu_Init( void ) {
	...
	setupMenuInfo.banner.string						= (char *)"SETUP";
	...
	setupMenuInfo.setupplayer.string				= (char *)"PLAYER";
	...
	setupMenuInfo.setupcontrols.string				= (char *)"CONTROLS";
	...
	setupMenuInfo.setupsystem.string				= (char *)"SYSTEM";
	...
	setupMenuInfo.game.string						= (char *)"GAME OPTIONS";
	...
	setupMenuInfo.cdkey.string						= (char *)"CD Key";
	...
	if( !trap_Cvar_VariableValue( "cl_paused" ) ) {
		...
		setupMenuInfo.defaults.string					= (char *)"DEFAULTS";
