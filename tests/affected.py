...
FAST = ('agent_protocol', 'agent_client', 'agent_formats', 'affected_contract',
        'state', 'animation', 'physics', 'ui_framework', 'audio_spatial', 'audio_events', 'audio_streams', 'audio_voice', 'capture', 'weapons', 'effects', 'effects_reference', 'post', 'temporal', 'lod', 'streaming', 'native_math', 'native_shared', 'replication',
...
RULES = (
    (('engine/qcommon/state.cpp', 'engine/public/state_public.h', 'engine/public/state_replication.h', 'tools/replication.py', 'engine/qcommon/q_shared.h', 'game/bg/q_shared.h', 'tests/state.py', 'tests/probes/state.cpp'), ('state',)),
