...
int main( void ) {
	...
	SHOW(entityShared_t);
	SHOW(vmCvar_t);
	SHOW(bot_entitystate_t);
	SHOW(bot_input_t);
	SHOW(bot_goal_t);
	SHOW(bot_initmove_t);
	SHOW(bot_moveresult_t);
	SHOW(bot_match_t);
	SHOW(weaponinfo_t);
	SHOW(aas_clientmove_t);
	SHOW(aas_entityinfo_t);
	SHOW(aas_areainfo_t);
	SHOW(aas_predictroute_t);
	SHOW(aas_altroutegoal_t);
	SHOW(pc_token_t);
	SHOW(qtime_t);
	SHOW(snapshot_t);
	SHOW(uiClientState_t);
	SHOW(glconfig_t);
	SHOW(fontInfo_t);
	SHOW(gameState_t);
	SHOW(orientation_t);
