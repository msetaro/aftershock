...
// Main-thread bridge for #180's SDK ticket transport. A session is a connection generation,
...
// Returns the provider (0 anonymous, 1 Steam, 2 verified backend), and clears id unless authenticated.
