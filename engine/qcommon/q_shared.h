...
// Inventory only: #pragma warning(disable : 4206)		// nonstandard extension used: translation unit is empty
...
// Inventory only: #pragma warning(disable : 4091)		// 'typedef': ignored on lef of <..> when no variable is declared
