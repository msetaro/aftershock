...
set(COOKED_SHADER_DIR "" CACHE PATH "Optional cooker output containing shader package replacements")
if(COOKED_SHADER_DIR)
  list(APPEND shader_command --cooked "${COOKED_SHADER_DIR}")
endif()
if(SHADER_COMPILER)
