...
void UI_PlayerInfo_SetInfo( playerInfo_t *pi, int legsAnim, int torsoAnim, vec3_t viewAngles, vec3_t moveAngles, int weaponNum, qboolean chat );
...
int trap_FS_Seek( fileHandle_t f, fsOffset_t offset, int origin ); // fsOrigin_t
