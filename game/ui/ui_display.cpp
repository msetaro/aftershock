...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.banner.string = (char *)"SYSTEM SETUP";
	...
	displayOptionsInfo.graphics.string = (char *)"GRAPHICS";
	...
	displayOptionsInfo.display.string = (char *)"DISPLAY";
	...
	displayOptionsInfo.sound.string = (char *)"SOUND";
	...
	displayOptionsInfo.network.string = (char *)"NETWORK";
