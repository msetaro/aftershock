...
static void UI_CinematicsMenu_Init( void ) {
	...
	cinematicsMenuInfo.banner.string			= (char *)"CINEMATICS";
	...
	cinematicsMenuInfo.cin_idlogo.string			= (char *)"ID LOGO";
	...
	cinematicsMenuInfo.cin_intro.string				= (char *)"INTRO";
	...
	cinematicsMenuInfo.cin_tier1.string				= (char *)"Tier 1";
	...
	cinematicsMenuInfo.cin_tier2.string				= (char *)"Tier 2";
	...
	cinematicsMenuInfo.cin_tier3.string				= (char *)"Tier 3";
	...
	cinematicsMenuInfo.cin_tier4.string				= (char *)"Tier 4";
	...
	cinematicsMenuInfo.cin_tier5.string				= (char *)"Tier 5";
	...
	cinematicsMenuInfo.cin_tier6.string				= (char *)"Tier 6";
	...
	cinematicsMenuInfo.cin_tier7.string				= (char *)"Tier 7";
	...
	cinematicsMenuInfo.cin_end.string				= (char *)"END";
