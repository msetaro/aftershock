...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.banner.string				= (char *)"SYSTEM SETUP";
	...
	soundOptionsInfo.graphics.string			= (char *)"GRAPHICS";
	...
	soundOptionsInfo.display.string				= (char *)"DISPLAY";
	...
	soundOptionsInfo.sound.string				= (char *)"SOUND";
