...
static void UI_SPSkillMenu_SkillEvent( void *ptr, int notification ) {
	...
	SetSkillColor( UI_GetSkill(), color_red );
...
static void UI_SPSkillMenu_Init( void ) {
	...
	skillMenuInfo.art_banner.string				= (char *)"DIFFICULTY";
	...
	skillMenuInfo.item_baby.string				= (char *)"I Can Win";
	...
	skillMenuInfo.item_easy.string				= (char *)"Bring It On";
	...
	skillMenuInfo.item_medium.string			= (char *)"Hurt Me Plenty";
	...
	skillMenuInfo.item_hard.string				= (char *)"Hardcore";
	...
	skillMenuInfo.item_nightmare.string				= (char *)"NIGHTMARE!";
