...
=================
*/
static void UI_SPPostgameMenu_AgainEvent( void* ptr [[maybe_unused]], int event )
{
...
=================
*/
static void UI_SPPostgameMenu_NextEvent( void* ptr [[maybe_unused]], int event ) {
	int			currentSet;
	int			levelSet;
	int			level;
	int			currentLevel;
...
=================
*/
static void UI_SPPostgameMenu_MenuEvent( void* ptr [[maybe_unused]], int event )
{
	if (event != QM_ACTIVATED) {
		return;
	}
...
void UI_SPPostgameMenu_Cache( void ) {
	...
	buildscript = (qboolean)trap_Cvar_VariableValue("com_buildscript");
