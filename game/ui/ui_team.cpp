...
void TeamMain_MenuInit( void ) {
	...
	s_teammain.joinred.string = (char *)"JOIN RED";
	...
	s_teammain.joinblue.string = (char *)"JOIN BLUE";
	...
	s_teammain.joingame.string = (char *)"JOIN GAME";
	...
	s_teammain.spectate.string = (char *)"SPECTATE";
