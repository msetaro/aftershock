...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.banner.string = (char *)"SYSTEM SETUP";
	...
	networkOptionsInfo.graphics.string = (char *)"GRAPHICS";
	...
	networkOptionsInfo.display.string = (char *)"DISPLAY";
	...
	networkOptionsInfo.sound.string = (char *)"SOUND";
	...
	networkOptionsInfo.network.string = (char *)"NETWORK";
