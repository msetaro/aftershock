...
==================
*/
void BotVoiceChat_GetFlag(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	//
	if (gametype == GT_CTF) {
...
==================
*/
void BotVoiceChat_Defend(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
#ifdef MISSIONPACK
...
==================
*/
void BotVoiceChat_Patrol(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	//
	bs->decisionmaker = client;
	//
	bs->ltgtype = 0;
...
==================
*/
void BotVoiceChat_Camp(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	int areanum;
...
==================
*/
void BotVoiceChat_FollowMe(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	int areanum;
	aas_entityinfo_t entinfo;
	char netname[MAX_NETNAME];
...
==================
*/
void BotVoiceChat_FollowFlagCarrier(bot_state_t *bs, int client [[maybe_unused]], int mode) {
	int carrier;
...
==================
*/
void BotVoiceChat_ReturnFlag(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	//if not in CTF mode
	if (
		gametype != GT_CTF
#ifdef MISSIONPACK
...
==================
*/
void BotVoiceChat_StartLeader(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
...
==================
*/
void BotVoiceChat_StopLeader(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
...
==================
*/
void BotVoiceChat_WhoIsLeader(bot_state_t *bs, int client [[maybe_unused]], int mode [[maybe_unused]]) {
	char netname[MAX_MESSAGE_SIZE];
...
==================
*/
void BotVoiceChat_WantOnDefense(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	char netname[MAX_NETNAME];
	int preference;
...
==================
*/
void BotVoiceChat_WantOnOffense(bot_state_t *bs, int client, int mode [[maybe_unused]]) {
	char netname[MAX_NETNAME];
	int preference;
...
void BotVoiceChat_Dummy(bot_state_t *bs [[maybe_unused]], int client [[maybe_unused]], int mode [[maybe_unused]]) {
}
